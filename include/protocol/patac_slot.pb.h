...
class ParkingSlotList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:patac_hpp.ParkingSlotList) */ {
 public:
  ...
  static const int kParkingSlotListFieldNumber = 3;
  ...
  static const int kNumParkingSlotFieldNumber = 2;
...
inline ::google::protobuf::uint64 ParkingSlotList::timestamp() const {
  // @@protoc_insertion_point(field_get:patac_hpp.ParkingSlotList.timestamp)
  return timestamp_;
}
inline void ParkingSlotList::set_timestamp(::google::protobuf::uint64 value) {
  
  timestamp_ = value;
  // @@protoc_insertion_point(field_set:patac_hpp.ParkingSlotList.timestamp)
}
