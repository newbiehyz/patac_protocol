//
#ifndef AUTODRIVE_INTERFACE_DYNAMIC_OBSTACLES_GT_DATA_H_
#define AUTODRIVE_INTERFACE_DYNAMIC_OBSTACLES_GT_DATA_H_
...
class DynamicObstaclesGtData final : public CommonMsgData {
 public:
  ...
  explicit DynamicObstaclesGtData(std::int64_t timestamp) noexcept;

  DynamicObstaclesGtData() noexcept;
  ~DynamicObstaclesGtData() noexcept final = default;
  DynamicObstaclesGtData(DynamicObstaclesGtData const&) = default;
  DynamicObstaclesGtData& operator=(DynamicObstaclesGtData const&) = default;
  DynamicObstaclesGtData(DynamicObstaclesGtData&&) = default;
  DynamicObstaclesGtData& operator=(DynamicObstaclesGtData&&) = default;
