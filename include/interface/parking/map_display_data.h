//
#ifndef AUTODRIVE_INTERFACE_MAP_DISPLAY_DATA_H_
#define AUTODRIVE_INTERFACE_MAP_DISPLAY_DATA_H_
...
class MapDisplayData final : public CommonMsgData {
 public:
  ...
  struct alignas(8) MapCommonHeader {
    ...
    std::array<Vector2f, kMaxGlbTrajectoryPointSeNSize> glb_trajectory_point;
  };
  ...
  explicit MapDisplayData(std::int64_t timestamp) noexcept;

  MapDisplayData() noexcept;
  ~MapDisplayData() noexcept final = default;
  MapDisplayData(MapDisplayData const&) = default;
  MapDisplayData& operator=(MapDisplayData const&) = default;
  MapDisplayData(MapDisplayData&&) = default;
  MapDisplayData& operator=(MapDisplayData&&) = default;
