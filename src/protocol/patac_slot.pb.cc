...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::patac_hpp::ParkingSlotList, timestamp_),
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "\030\n\020num_parking_slot\030\002 \001(\r\0221\n\021parking_slo"
      "t_list\030\003 \003(\0132\026.patac_hpp.ParkingSlot*g\n\017"
      "ParkingSlotType\022\023\n\017SlotTypeUnknown\020\000\022\024\n\020"
      "SlotTypeVertical\020\001\022\024\n\020SlotTypeParallel\020\002"
      "\022\023\n\017SlotTypeOblique\020\003*j\n\017OccupancyStatus"
      "\022\032\n\026OccupancyStatusUnknown\020\000\022\033\n\027Occupanc"
      "yStatusOccupied\020\001\022\036\n\032OccupancyStatusNotO"
      "ccupied\020\002*s\n\rParkingSource\022\034\n\030ParkingSou"
      "rceUnspecified\020\000\022\024\n\020ParkingSourceIpm\020\001\022\024"
      "\n\020ParkingSourceUss\020\002\022\030\n\024ParkingSourceUse"
      "rSel\020\003*h\n\021ParkingLockStatus\022\034\n\030ParkingLo"
      "ckStatusUnknown\020\000\022\031\n\025ParkingLockStatusOp"
      "en\020\001\022\032\n\026ParkingLockStatusClose\020\002b\006proto3"
  };
...
ParkingSlotList::ParkingSlotList(const ParkingSlotList& from)
  ...
  ::memcpy(&timestamp_, &from.timestamp_,
    static_cast<size_t>(reinterpret_cast<char*>(&num_parking_slot_) -
    reinterpret_cast<char*>(&timestamp_)) + sizeof(num_parking_slot_));
  // @@protoc_insertion_point(copy_constructor:patac_hpp.ParkingSlotList)
}

void ParkingSlotList::SharedCtor() {
  ::memset(&timestamp_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&num_parking_slot_) -
      reinterpret_cast<char*>(&timestamp_)) + sizeof(num_parking_slot_));
  _cached_size_ = 0;
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // repeated .patac_hpp.ParkingSlot parking_slot_list = 3;
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
void ParkingSlotList::SerializeWithCachedSizes(
  ...
  if (this->num_parking_slot() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->num_parking_slot(), output);
  }
  ...
  for (unsigned int i = 0,
    ...
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->parking_slot_list(static_cast<int>(i)), output);
  }
...
::google::protobuf::uint8* ParkingSlotList::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 num_parking_slot = 2;
  if (this->num_parking_slot() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->num_parking_slot(), target);
  }
  ...
  for (unsigned int i = 0,
    ...
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        3, this->parking_slot_list(static_cast<int>(i)), deterministic, target);
  }
